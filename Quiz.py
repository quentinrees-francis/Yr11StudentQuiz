"""This program has the user answer various trivia questions about Mario words and place names, tracking score and correcting the user if they get a question wrong more than once."""
import easygui
score = 0
q_num = 1
TITLE = "Maori Quiz"
...
while True:
  ...
  # Defines the answers for the questions, and organizes them into a listcarl
  correct_answers = [
  "b) raro",
  "a) book",
  "b) karaka",
  ...
  if name == "":
    ...
    quit()
  easygui.msgbox(f"Welcome to the Maori Trivia Game {name}. This quiz tests your understanding of Maori words", TITLE)
  # Welcomes the user to the quiz, asks the user for their name.
  age = easygui.integerbox("How old are you? ", TITLE)
  if age < MAX_AGE and age > MIN_AGE:
    # Checks user age is in the right age range to play
    ...
    quit()  
  # Checks if the user is too young or too old to play. If they are, it will quit the quiz.
